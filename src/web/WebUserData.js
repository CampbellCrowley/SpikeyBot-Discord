...
class WebUserData {
   ...
   * @public
   * @param {string[]} guilds Array of guild IDs for this user.
   */
  setGuilds(guilds) {
    if (!Array.isArray(guilds) || typeof guilds[0] !== 'string') {
      throw new TypeError('Guild data is not array of strings.');
    }
    this.guilds = guilds;
  }
  ...
  static from(obj) {
    ...
    out.descriminator = obj.descriminator || null;
