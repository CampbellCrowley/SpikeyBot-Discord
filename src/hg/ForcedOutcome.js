...
/**
 * @classdesc An outcome for one or more players in a game.
 * @class HungryGames~ForcedOutcome
 *
 ...
 * victims of by the end of the simulated day. ("living", "dead", "wounded", or
 * "thriving").
 ...
 */
function ForcedOutcome(id, list, state, text, persists = false) {
  if (typeof id === 'object') {
