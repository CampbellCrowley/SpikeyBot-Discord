...
2) Install [NodeJS](https://nodejs.org/)
    - The bot is currently running on NodeJS [v10.16.1](https://nodejs.org/dist/v10.16.1/). Other versions may work, but are untested.
...
5) Install dependencies via NPM
    - Current version of NPM used is `v6.10.3`, but almost any version should be fine.
